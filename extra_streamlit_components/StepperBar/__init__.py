...
def stepper_bar(steps: List[str], is_vertical: bool = False, lock_sequence: bool = True, default=0) -> CustomComponent:
    component_value = _component_func(steps=steps, is_vertical=is_vertical, lock_sequence=lock_sequence, default=default)
    return component_value
